...
```shell
wget --no-check-certificate -O install.sh https://raw.githubusercontent.com/fakedon/IBMYes/master/install.sh && chmod +x install.sh  && ./install.sh
```
...
```
https://github.com/fakedon/IBMYes
```
